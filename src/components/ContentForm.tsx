...
import { Save, Eye, X, Plus, Image as ImageIcon } from 'lucide-react';
          ...
          <form onSubmit={(e) => handleSubmit(e)} className="space-y-6">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              ...
              <textarea
                ...
                required
              />
              <p className="text-xs text-slate-500 mt-2">Markdown supported</p>
            </div>
            ...
            {formData.featuredImage ? (
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-slate-700 rounded-lg p-8 text-center hover:border-blue-500 transition cursor-pointer">
                  ...
                  <p className="text-sm text-slate-400">Click to upload or enter URL above</p>
                </div>
              </div>
            )}
          </div>
