            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: 'Content published', desc: 'Notify when content is published' },
                  { label: 'Weekly reports', desc: 'Receive weekly analytics reports' },
                  { label: 'Security alerts', desc: 'Important security notifications' },
                ].map((item, index) => (
                  <label key={index} className="flex items-center justify-between p-4 bg-slate-800 rounded-lg cursor-pointer hover:bg-slate-700 transition">
                    <div>
